...
public abstract class MediaWrapper extends MediaLibraryItem implements Parcelable {
    ...
    public MediaWrapper(long id, String mrl, long time, float position, long length, int type, String title,
        ...
        init(time, position, length, type, null, title, artistId, albumArtistId, artist, genre, albumId, album, albumArtist, width, height,
                ...
                trackNumber, discNumber, lastModified, seen, isPresent, null, isFavorite, insertionDate, null, nbSubscriptions, releaseDate);
    ...
    private void init(long time, float position, long length, int type,
                      ...
                      long seen, boolean isPresent, IMedia.Slave[] slaves, boolean isFavorite, long insertionDate, String tag, int nbSubscriptions, int releaseYear) {
        mFilename = null;
        mTime = time;
        mPosition = position;
        mDisplayTime = time;
    ...
    public MediaWrapper(Uri uri, long time, float position, long length, int type,
        ...
        init(time, position, length, type, picture, title, artistId, albumArtistId, artist, genre, albumId, album, albumArtist,
                width, height, artworkURL, audio, spu, trackNumber, discNumber, lastModified, seen, true, null, isFavorite, insertionDate, null, nbSubscriptions, releaseYear);
    }
