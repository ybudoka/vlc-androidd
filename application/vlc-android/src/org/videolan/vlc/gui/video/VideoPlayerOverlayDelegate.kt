    ...
    fun showControls(show: Boolean) {
        ...
        if (::hudBinding.isInitialized) {
            ...
            if (seekButtons) {
                ...
                hudBinding.playerOverlayRewind.contentDescription = player.resources.getQuantityString(R.plurals.talkback_action_rewind, Settings.videoJumpDelay, Settings.videoJumpDelay)
                ...
                hudBinding.playerOverlayForward.contentDescription = player.resources.getQuantityString(R.plurals.talkback_action_forward, Settings.videoJumpDelay, Settings.videoJumpDelay)
